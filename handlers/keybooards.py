...
def kebn():
    butto = [[types.KeyboardButton(text = '/start'), types.KeyboardButton(text='/help')],[types.KeyboardButton(text='/work_schedule')],[types.KeyboardButton(text='/watch_schedule')], [types.KeyboardButton(text='/Template')]]
    return types.ReplyKeyboardMarkup(keyboard=butto, resize_keyboard=True)


def kebad():
    butto = [[types.KeyboardButton(text='/add_schedule'),types.KeyboardButton(text='/add_schedule_file'),types.KeyboardButton(text='/add_time')],[ types.KeyboardButton(text='/time_change'), types.KeyboardButton(text='/change_train') ,types.KeyboardButton(text='/del_schedule')],[types.KeyboardButton(text='/back')]]
    return types.ReplyKeyboardMarkup(keyboard=butto, resize_keyboard=True)
